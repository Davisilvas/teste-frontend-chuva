...
let add = () => {
    ...
    if (newTopic.classList = 'discussions-newTopic'){
        notoTopico.remove();
        newTopic.innerHTML = "                                        <span class='duvidaOuPergunta'>Tem uma dúvida ou sugestão? Compartilhe seu feedback com os autores!</span>              <h2 class='t1'>Assunto</h2>                                 <input type='text' class='inputAssunto'>                        <h2 class='t2'>Conteúdo</h2>                                <input type='text' class='inputConteudo'>                                          <img src='./assets/images/bold.png'>                           <img src='./assets/images/italic.png'>                      <button>Enviar</button>"
    }else{
