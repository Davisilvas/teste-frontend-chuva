...
//     const notoTopico = document.getElementById('novoTopico');
    ...
    //     notoTopico.remove();
    //     newTopic.innerHTML = "                                        <div class='insideButton'>                                    <span class='duvidaOuPergunta'class='spanButton'>Tem uma dúvida ou sugestão? Compartilhe seu feedback com os autores!</span>                                                        <h2 class='t1'>Assunto</h2>                                 <input type='text' class='inputAssunto'>                        <h2 class='t2'>Conteúdo</h2>                                <input type='text' class='inputConteudo'>                                          <img src='./assets/images/bold.png' class='bold'>                                               <img src='./assets/images/italic.png' class='italic'>                                                 <button class='sendButton'>Enviar<button>                               </div>"
    // }else{
